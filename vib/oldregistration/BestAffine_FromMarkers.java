...
public class BestAffine_FromMarkers extends RegistrationAlgorithm implements PlugIn {
        ...
        public void run(String arg) {
                ...
                if (wList==null) {
                        IJ.error("BestAffine_FromMarkers.run(): No images are open.");
                        return;
                }
        ...
        public OrderedTransformations register() {
                ...
                if(points0==null) {
                        ...
                        System.out.println("for 0 in BestAffine_FromMarkers.register()");
                        return null;
                }
                ...
                if(points1==null) {
                        ...
                        System.out.println("for 1 in BestAffine_FromMarkers.register()");
                        return null;
                }
