...
public class Affine_FromMarkers extends RegistrationAlgorithm implements PlugIn {
        ...
        public void run(String arg) {
                ...
                if (wList==null) {
                        IJ.error("Affine_FromMarkers: No images are open.");
                        return;
                }
        ...
        public OrderedTransformations register() {
                ...
                if(points0==null) {
                        ...
                        System.out.println("for 0 in Affine_FromMarkers.register()");
                        return null;
                }
                ...
                if(points1==null) {
                        ...
                        System.out.println("for 1 in Affine_FromMarkers.register()");
                        return null;
                }
