...
public class Albert_Test implements PlugIn {
	...
	public void run(String ignored) {
		...
		TracerThread tracer = new TracerThread(imagePlus, timeoutSeconds, reportEveryMilliseconds, start_x, start_y, start_z, goal_x, goal_y, goal_z, reciprocal, hessian, null, hessian != null );
