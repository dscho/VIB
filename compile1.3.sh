...
java5s="Moving_Least_Squares.java adt/Connectivity2D.java adt/Points.java adt/Sparse3DByteArray.java Affine_FromMarkers.java AutoLabeller.java AutoLabellerNaive.java BatchProcessor_.java events/RoiWatcher.java events/SliceWatcher.java Fill_holes.java gui/GuiBuilder.java LabelBinaryOps.java LabelInterpolator_.java LabelThresholder_.java Name_Points.java OrderedTransformations.java PCA_Registration.java Segmentator_.java Segmenter_.java Utils.java vib/PointList.java vib/BenesName_Points.java vib/LocalRigidRegistration_.java Particle_Analyzer_3D.java marchingcubes/MCCube.java marchingcubes/MCShape.java vib/app/FileGroup.java vib/app/gui/Bubble.java vib/app/Options.java vib/app/gui/dialog/FileGroupDialog.java vib/app/gui/dialog/OptionsDialog.java vib/app/module/Module.java vib/app/module/Load.java vib/Center_Transformation.java ij3d/RoiCanvas3D.java voltex/VolRend.java vib/app/gui/FileGroupDialog.java vib/Show_centers.java isosurface/IsoShape.java"
for i in $java5s; do
	if [ -e $i ]; then
