 ...
 */
public class EditableVolumeRenderer implements VolRendConstants {

	/** The image data which is rendered by this VolumeRenderer */
	protected final EditableVolume volume;
	 ...
	 * respectively.
	 */
	public EditableVolumeRenderer(ImagePlus img) {

		this.volume = new EditableVolume(img);
		appCreator = new AppearanceCreator(volume);
