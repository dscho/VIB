...
public class FastMatrix {
    ...
    */
    ...
    /* Find a first rotation to map v2_domain to v2_template.  Then
       project the v1s down onto the plane defined by v2_template, and
       find the rotation about v2_domain that lines up the projected V1s. */

    /* FIXME: with the PCA results, then v2 and v1 are always going to
     * be orthogonal anyway, so in fact the code that projects onto
     * the plane hasn't been sensibly tested (and is useless for the
     * moment.). */
    ...
    public static FastMatrix rotateToAlignVectors( double [] v2_template,
        ...
        /*
        System.out.println( "Angle between the vectors with the largest eigenvalues are: " +
                            Math.toDegrees( angleBetween ) + " degrees." );
        */
        ...
        /*
        System.out.println( "Normal vector is: " + normal[0] + ", " + normal[1] + ", " + normal[2] );
        */
        ...
        /*
        System.out.println( "The rotation matrix is:\n" + rotation.toStringIndented(" ") );
        System.out.println( "... with determinant: " + rotation.det() );
        */
        ...
        */
        ...
        /*
        System.out.println( "Angle between the the projected v1s (after rotating the domain)" +
                            Math.toDegrees( angleBetweenV1sA ) + " degrees." );
        */
        ...
        /*
        System.out.println( "The second rotation matrix is:\n" + secondRotationA.toStringIndented("  ") );
        System.out.println( "... with determinant: " + secondRotationA.det() );
        */
