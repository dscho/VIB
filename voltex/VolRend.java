...
public class VolRend implements MouseBehaviorCallback {
	...
	public VolRend() {
		canvas = new ImageCanvas3D(
			SimpleUniverse.getPreferredConfiguration(), 512, 512);
	...
	private BranchGroup createSceneGraph() {
		...
		updateCenter(new Point3d(0.0, 0.0, 0.0), 
	...
	public Point2d volumePointInCanvas(Renderer rend, 
				Transform3D volToIP, int x,int y,int z) {
